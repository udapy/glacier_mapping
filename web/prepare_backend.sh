...
python3 -m web.backend.backend_data -d $DATA_DIR/analysis_images/ -o $ROOT_DIR/web/frontend/outputs/basemap/ -n output-full.vrt # tiles/ directory must exist
python3 -m web.backend.backend_data -d $DATA_DIR/analysis_images/ -o $ROOT_DIR/web/frontend/outputs/basemap/ -n output-245.vrt --bandList 5 4 2
